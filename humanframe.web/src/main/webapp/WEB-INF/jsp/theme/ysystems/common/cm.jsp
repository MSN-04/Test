				...
				<div class="row">
					<div class="form-group">
						<div class="col-md-4">
							...
							<input type="text" value="" maxlength="100" class="form-control" name="wrter" id="cm-wrter">
						</div>
						<div class="col-md-4">
							<label for="cm-emailAdres">Your email address *</label>
							<input type="email" value="" maxlength="100" class="form-control" name="emailAdres" id="cm-emailAdres">
						</div>
						<div class="col-md-4">
							<label for="cm-password">Your password *</label>
							<input type="password" value="" maxlength="100" class="form-control" name="password" id="cm-password">
						</div>
					</div>
				</div>
				</c:if>
