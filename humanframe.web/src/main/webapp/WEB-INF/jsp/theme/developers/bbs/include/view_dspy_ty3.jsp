	...
	<c:when test="${viewObj.key eq 'cn' }"><!-- 내용 -->
		...
		<tr>
			...
			<td>
				...
				<c:if test="${fn:indexOf('jpg|png|gif', bbsFileList.fileExtsn) > -1}">
				<img src="/comm/getImage?srvcId=${bbsFileList.srvcId }&amp;upperNo=${bbsFileList.upperNo }&amp;fileTy=${bbsFileList.fileTy }&amp;fileNo=${bbsFileList.fileNo}&amp;thumbTy=M" alt="<spring:message code='ui.thumbnail' />${status.index+1}"/><br/><br/>
				</c:if>
				</c:forEach>
			</td>
		</tr>
