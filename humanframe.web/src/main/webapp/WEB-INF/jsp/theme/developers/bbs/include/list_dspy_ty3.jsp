...
<div class="row mt-xlg">
	...
	<div class="col-md-4">
		<a href="${currUri}/${imageList.nttNo}">
			<span class="thumb-info thumb-info-centered-info">
				<span class="thumb-info-wrapper">
					<img src="/comm/getImage?srvcId=BBSTY3&amp;upperNo=${imageList.nttNo}&amp;fileTy=ATTACH&amp;fileNo=${imageList.fileNo}&amp;thumbTy=M" class="img-responsive" alt="${imageList.sj} <spring:message code='ui.thumbnail' />">
					<span class="thumb-info-title">
						<span class="thumb-info-inner">${imageList.sj} <em>${imageList.writngDe}</em></span>
