...
<%@ include file="/common/taglibs.jsp" %>
	...
	$(document).ready(function(){
		...
		$("form[name=menuUploadFrm]").submit(function(e) {
		    e.preventDefault();
		}).validate({
			...
			<div class="col-md-6 pr-none pl-none">
				<form class="form-horizontal form-bordered" name="menuUploadFrm" method="post" enctype="multipart/form-data" action="menuUploadAction.json">
				<section class="panel panel-primary mb-none">
					<header class="panel-heading">
						...
						<h2 class="panel-title">메뉴 일괄 등록</h2>
						<p class="panel-subtitle">번들 파일을 사용하여 메뉴를 일괄 등록합니다.</p>
					</header>
					<div class="panel-body">
							<div class="form-group">
								...
								<div class="col-sm-6">
									...
									<a class="btn btn-info btn-sm" href="${globalAdminAssets}/samples/cms-create-menu-bundle-template.zip">
