...
<%@ include file="../include/load_plugin.jsp" %>
	...
	function f_save(){
		if($("input:checkbox[name=resveAt]").is(":checked")){
			$("#frmNtt2 input[name=resveBeginDttm]").rules("add", {required: true});
			$("#frmNtt2 input[name=resveEndDttm]").rules("add", {required: true});
		}
	...
	function leadingZeros(n, digits) {
		...
		<div class="row">
			<div class="col-md-12">
			<f:form modelAttribute="nttVO" method="post" name="frmNtt2" id="frmNtt2" enctype="multipart/form-data" action="./action" cssClass="form-horizontal form-bordered mb-md">
			<f:hidden path="crud" />
			<f:hidden path="bbsNo" />
			<f:hidden path="nttNo" />
				...
				<div class="panel-body">
					<!-- Start Selectable Table Row -->
						<table class="table table-bordered mb-none">
									...
									<tbody>
									<c:if test="${nttVO.nttGroupCnt == 1 || nttVO.crud == 'CREATE'}">
									<tr>
										<th>게시글 설정</th>
										<td>
