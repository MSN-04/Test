...
<%@ include file="/common/taglibs.jsp" %>
	...
	function f_confm() {
		if( confirm("<spring:message code='action.confirm.comfm' />") ) {
			$("#crud").val("CONFM");
			document.frmNtt.action = "action";
			document.frmNtt.submit();
		}
										...
										<tr>
											...
											<td>
												<div class="control-group">
													...
													<span class="checkbox-custom checkbox-text-primary checkbox-inline">
													<f:checkbox path="topNttAt" value="Y" label="상위글" disabled="true" cssClass="form-control"/></span>
													<span class="checkbox-custom checkbox-text-primary checkbox-inline">
					...
					<div class="row">
						...
						<div class="col-sm-5">
							<div class="btns">
								...
								<c:if test="${nttVO.confmAt eq 'N'}"><a href="#" onclick="f_confm(); return false;" class="btn btn-success">승인</a></c:if>
							</div>
						</div>
					</div>
				</footer>
