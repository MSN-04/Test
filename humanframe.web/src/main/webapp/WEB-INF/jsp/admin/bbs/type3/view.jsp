											...
											<c:when test="${viewObj.key eq 'cn' }"><!-- 내용 -->
												...
												<tr>
													...
													<td>
														...
														<br/><img src="/comm/getImage?srvcId=${bbsFileList.srvcId }&amp;upperNo=${bbsFileList.upperNo }&amp;fileTy=${bbsFileList.fileTy }&amp;fileNo=${bbsFileList.fileNo}&amp;thumbTy=M" alt="썸네일 이미지${status.index+1}"/><br/>
														</c:if>
														</c:forEach>
													</td>
												</tr>
